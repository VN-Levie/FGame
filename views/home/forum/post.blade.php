          ...
          <div class="row">
               <div class="col-12 col-xl-12 mb-4 mb-lg-0 mt-3">
                    <div class="card">
                         ...
                         <hr>
                         {{-- nếu là sửa thì trở về xem bài viết, nếu là tạo thì trở về home --}}
                         @if ($post?->id)
                              <a href="{{ route("forum.detail", ["id" => $post->id]) }}" class="btn btn-block btn-light">
                                   <i class="fas fa-arrow-left"></i> Xem bài viết
                              </a>
                             @else
                              <a href="{{ route("home") }}" class="btn btn-block btn-light">
